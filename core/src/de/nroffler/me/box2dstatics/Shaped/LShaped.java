...
public class LShaped extends StaticCollidableWorldObject {

    public LShaped(World world, float x, float y) {
        super(world, x, y);
    }
    ...
    public void defineObject() {
        ...
        if (x > (200 / Statics.PPM)) {
            ...
            vertice2[0] = new Vector2(width * Statics.PPM, -12).scl(1 / Statics.PPM);
            vertice2[1] = new Vector2(width * Statics.PPM + 20, 48).scl(1 / Statics.PPM);
            vertice2[2] = new Vector2(width * Statics.PPM + 40, 36).scl(1 / Statics.PPM);
            vertice2[3] = new Vector2(width * Statics.PPM + 20, -12).scl(1 / Statics.PPM);
            shape.set(vertice2);
            fixtureDef.shape = shape;
            fixtureDef.filter.categoryBits = BitFilter.COLLIDE_OBJECT;
            body.createFixture(fixtureDef).setUserData(this);
            ...
            vertice3[0] = new Vector2(-width * Statics.PPM, -12).scl(1 / Statics.PPM);
            vertice3[1] = new Vector2(-width * Statics.PPM - 20, 48).scl(1 / Statics.PPM);
            vertice3[2] = new Vector2(-width * Statics.PPM - 40, 36).scl(1 / Statics.PPM);
            vertice3[3] = new Vector2(-width * Statics.PPM - 20, -12).scl(1 / Statics.PPM);
            shape.set(vertice3);
            fixtureDef.shape = shape;
            fixtureDef.filter.categoryBits = BitFilter.COLLIDE_OBJECT;
            body.createFixture(fixtureDef).setUserData(this);
